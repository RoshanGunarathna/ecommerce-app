...
class GetEmailScreen extends ConsumerStatefulWidget {
  final String uid;
  ...
  @override
  ConsumerState<GetEmailScreen> createState() => _GetEmailScreenConsumerState();
}

class _GetEmailScreenConsumerState extends ConsumerState<GetEmailScreen> {
